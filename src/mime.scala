...
trait MimeTyping {
  ...
  object MimeTypes {
    ...
    val `application/mbms-protection-description+xml` =
    ...
    val `application/prs.alvestrand.titrax-sheet` =
    ...
    val `application/vnd.airzip.filesecure.azf` =
      MimeType("application/vnd.airzip.filesecure.azf", "azf")
    
    val `application/vnd.airzip.filesecure.azs` =
    ...
    val `application/vnd.antix.game-component` =
      MimeType("application/vnd.antix.game-component", "atx")
    
    val `application/vnd.apple.installer+xml` =
    ...
    val `application/vnd.cendio.thinlinc.clientconf` =
    ...
    val `application/vnd.chipnuts.karaoke-mmd` =
    ...
    val `application/vnd.clonk.c4group` =
    ...
    val `application/vnd.crick.clicker.keyboard` =
      MimeType("application/vnd.crick.clicker.keyboard", "clkk")
    
    val `application/vnd.crick.clicker.palette` =
      MimeType("application/vnd.crick.clicker.palette", "clkp")

    val `application/vnd.crick.clicker.template` =
      MimeType("application/vnd.crick.clicker.template", "clkt")
    
    val `application/vnd.crick.clicker.wordbank` =
      MimeType("application/vnd.crick.clicker.wordbank", "clkw")
    
    val `application/vnd.criticaltools.wbs+xml` =
    ...
    val `application/vnd.denovo.fcselayout-link` =
      MimeType("application/vnd.denovo.fcselayout-link", "fe", "_launch")
    
    val `application/vnd.dir-bi.plate-dl-nosuffix` =
    ...
    val `application/vnd.dvb.iptv.alfec-enhancement` =
      MimeType("application/vnd.dvb.iptv.alfec-enhancement")
    
    val `application/vnd.dvb.notif-aggregate-root+xml` =
      MimeType("application/vnd.dvb.notif-aggregate-root+xml")
    
    val `application/vnd.dvb.notif-container+xml` =
    ...
    val `application/vnd.dvb.notif-ia-msglist+xml` =
    ...
    val `application/vnd.emclient.accessrequest+xml` =
    ...
    val `application/vnd.framemaker` =
    ...
    val `application/vnd.geometry-explorer` =
    ...
    val `application/vnd.groove-identity-message` =
    ...
    val `application/vnd.handheld-entertainment+xml` =
    ...
    val `application/vnd.hydrostatix.sof-data` =
    ...
    val `application/vnd.ibm.modcap` =
      MimeType("application/vnd.ibm.modcap", "afp", "list3820", "listafp")
    
    val `application/vnd.ibm.rights-management` =
      MimeType("application/vnd.ibm.rights-management", "irm")
    
    val `application/vnd.ibm.secure-container` =
    ...
    val `application/vnd.informedcontrol.rms+xml` =
    ...
    val `application/vnd.intercon.formnet` =
    ...
    val `application/vnd.iptc.g2.conceptitem+xml` =
      MimeType("application/vnd.iptc.g2.conceptitem+xml")
    
    val `application/vnd.iptc.g2.knowledgeitem+xml` =
    ...
    val `application/vnd.iptc.g2.packageitem+xml` =
      MimeType("application/vnd.iptc.g2.packageitem+xml")
    
    val `application/vnd.ipunplugged.rcprofile` =
      MimeType("application/vnd.ipunplugged.rcprofile", "rcprofile")
    
    val `application/vnd.irepository.package+xml` =
    ...
    val `application/vnd.japannet-directory-service` =
      MimeType("application/vnd.japannet-directory-service")
    
    val `application/vnd.japannet-jpnstore-wakeup` =
      MimeType("application/vnd.japannet-jpnstore-wakeup")
    
    val `application/vnd.japannet-payment-wakeup` =
    ...
    val `application/vnd.japannet-registration-wakeup` =
      MimeType("application/vnd.japannet-registration-wakeup")
    
    val `application/vnd.japannet-setstore-wakeup` =
    ...
    val `application/vnd.japannet-verification-wakeup` =
    ...
    val `application/vnd.marlin.drm.actiontoken+xml` =
    ...
    val `application/vnd.ms-playready.initiator+xml` =
      MimeType("application/vnd.ms-playready.initiator+xml")
    
    val `application/vnd.ms-powerpoint` =
      MimeType("application/vnd.ms-powerpoint", "pot", "pps", "ppt")
    ...
    val `application/vnd.ms-wmdrm.meter-chlg-req` =
    ...
    val `application/vnd.nokia.isds-radio-presets` =
    ...
    val `application/vnd.nokia.landmarkcollection+xml` =
    ...
    val `application/vnd.oma.bcast.drm-trigger+xml` =
    ...
    val `application/vnd.oma.bcast.notification+xml` =
      MimeType("application/vnd.oma.bcast.notification+xml")
    
    val `application/vnd.oma.bcast.provisioningtrigger` =
    ...
    val `application/vnd.oma.group-usage-list+xml` =
    ...
    val `application/vnd.oma.poc.final-report+xml` =
    ...
    val `application/vnd.openofficeorg.extension` =
    ...
    val `application/vnd.publishare-delta-tree` =
    ...
    val `application/vnd.recordare.musicxml+xml` =
    ...
    val `application/vnd.route66.link66+xml` =
    ...
    val `application/vnd.sealedmedia.softseal.html` =
      MimeType("application/vnd.sealedmedia.softseal.html")
    
    val `application/vnd.sealedmedia.softseal.pdf` =
    ...
    val `application/vnd.shana.informed.formdata` =
      MimeType("application/vnd.shana.informed.formdata", "ifm")
    
    val `application/vnd.shana.informed.formtemplate` =
      MimeType("application/vnd.shana.informed.formtemplate", "itp")
    
    val `application/vnd.shana.informed.interchange` =
      MimeType("application/vnd.shana.informed.interchange", "iif")
    
    val `application/vnd.shana.informed.package` =
      MimeType("application/vnd.shana.informed.package", "ipk")
    
    val `application/vnd.simtech-mindmapper` =
    ...
    val `application/vnd.software602.filler.form+xml` =
    ...
    val `application/vnd.solent.sdkm+xml` =
    ...
    val `application/vnd.stardivision.impress` =
      MimeType("application/vnd.stardivision.impress", "sdd", "sdp")
    
    val `application/vnd.stardivision.math` =
      MimeType("application/vnd.stardivision.math", "sdf", "smf")
    
    val `application/vnd.stardivision.writer` =
      MimeType("application/vnd.stardivision.writer", "sdw", "vor")
    
    val `application/vnd.stardivision.writer-global` =
    ...
    val `application/vnd.sun.xml.calc.template` =
    ...
    val `application/vnd.sun.xml.draw.template` =
    ...
    val `application/vnd.sun.xml.impress.template` =
    ...
    val `application/vnd.sun.xml.writer.global` =
      MimeType("application/vnd.sun.xml.writer.global", "sxg")
    
    val `application/vnd.sun.xml.writer.template` =
    ...
    val `application/vnd.uplanet.bearer-choice-wbxml` =
    ...
    val `application/vnd.yamaha.openscoreformat` =
    ...
    val `application/vnd.yellowriver-custom-menu` =
    ...
    val `application/x-authorware-bin` =
    ...
    val `application/x-maker` =
      MimeType("application/x-maker", "book", "fb", "fbdoc", "fm", "frame", "frm", "maker")
    ...
    val `application/x-msdos-program` =
      MimeType("application/x-msdos-program", "bat", "com", "dll", "exe")
    
    val `application/x-msdownload` =
    ...
    val `application/x-pkcs7-certificates` =
    ...
    val `application/x-redhat-package-manager` =
      MimeType("application/x-redhat-package-manager", "rpm")
    ...
    val `application/xcon-conference-info-diff+xml` =
    ...
    val `audio/mpeg` =
      MimeType("audio/mpeg", "m2a", "m3a", "m4a", "mp2", "mp2a", "mp3", "mpega", "mpga")
    ...
    val `chemical/x-mopac-input` =
      MimeType("chemical/x-mopac-input", "dat", "mop", "mopcrt", "mpc", "zmt")
    ...
    val `message/global-disposition-notification` =
